...
// Caesar cipher
void Caesar(char *message, int k)
{                // Receive the message and the shift number
    int idx = 0; // Declare idx to store the index of the message
    while (message[idx] != '\0')
    {                            // Use while loop to iterate the string, until the end of the string
...
{ // Receive the message
    ...
    while (p > message )
    { // Use while loop to iterate the string, until the pointer is at the beginning of the string
...
int main()
{
    ...
    while (n > 0)
    {                                // Use while loop to iterate the test cases
